...
idx
average.tips.male <- mean(tips[idx, 'tip'])
average.tips.male

idx <- which(tips[, 'sex'] == 'Female')
idx
average.tips.female <- mean(tips[idx, 'tip'])
average.tips.female
...
idx
average.tips.nosmoke <- mean(tips[idx, 'tip'])
average.tips.nosmoke

idx <- which(tips[, 'smoker'] == 'Yes')
idx
average.tips.smoke <- mean(tips[idx, 'tip'])
average.tips.smoke
